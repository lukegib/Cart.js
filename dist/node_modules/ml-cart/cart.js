...
var Matrix__default = /*#__PURE__*/_interopDefaultLegacy(Matrix);
...
function toDiscreteDistribution(array, numberOfClasses) {
  ...
  return Matrix__default['default'].rowVector(counts);
}
...
class TreeNode {
  ...
  train(X, y, currentDepth, parentGain) {
    ...
    if (
      ...
      let lesserX = new Matrix__default['default'](splittedMatrix.lesserX);
      let greaterX = new Matrix__default['default'](splittedMatrix.greaterX);
    ...
    if (node.distribution !== undefined) {
      this.distribution =
        node.distribution.constructor === Array
          ? new Matrix__default['default'](node.distribution)
          : node.distribution;
    } else {
...
class DecisionTreeClassifier {
  ...
  train(trainingSet, trainingLabels) {
    ...
    trainingSet = Matrix__default['default'].checkMatrix(trainingSet);
   ...
   */
  predict(toPredict) {
    toPredict = Matrix__default['default'].checkMatrix(toPredict);
...
class DecisionTreeRegression {
  ...
  train(trainingSet, trainingValues) {
    ...
    if (
      ...
      trainingSet = Matrix__default['default'].columnVector(trainingSet);
    } else {
      trainingSet = Matrix__default['default'].checkMatrix(trainingSet);
    }
  ...
  predict(toPredict) {
    if (
      ...
      toPredict = Matrix__default['default'].columnVector(toPredict);
    }
    toPredict = Matrix__default['default'].checkMatrix(toPredict);
